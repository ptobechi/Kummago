...
class Messages extends Database{
    ...
    public function sendEmailVerification($email, $name){
        ...
        <!DOCTYPE html> 
            <html lang='en'>
                <head>
                    <link rel='shortcut icon' href='https://kumagofoods.store/view/assets/media/logos/favicon.ico' />
                    <link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700' />
                    <link href='https://kumagofoods.store/view/assets/plugins/global/plugins.bundle.css' rel='stylesheet' type='text/css' />
                    <link href='https://kumagofoods.store/view/assets/css/style.bundle.css' rel='stylesheet' type='text/css' />
                </head>
                <body id='kt_body' class='auth-bg'>
                        ...
                        <div class='d-flex flex-column flex-column-fluid'>
                            <div class='d-flex flex-column flex-column-fluid text-center p-10 py-lg-15'>
                                <a href='' class='mb-0 pt-lg-10'>
                                    <img alt='Logo' src='https://images.squarespace-cdn.com/content/v1/62318897f75ed7458e1a2c40/9ab81ec0-bc4f-4ef0-80ab-f64e48304174/IMG_5607.jpg?format=1500w' class='h-50px mb-0' />
                    ...
                    <script src='https://kumagofoods.store/view/assets/plugins/global/plugins.bundle.js'></script>
                    <script src='https://kumagofoods.store/view/assets/js/scripts.bundle.js'></script>
                </body>
            </html>
        ";
